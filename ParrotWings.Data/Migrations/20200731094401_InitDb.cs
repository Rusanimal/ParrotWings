        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransferTransactions_Users_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferTransactions_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Balances_TransferTransactions_TransferTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Balances_TransferTransactionId",
                table: "Balances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferTransactions_RecipientId",
                table: "TransferTransactions",
                column: "RecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferTransactions_SenderId",
                table: "TransferTransactions",
                column: "SenderId");
        }
